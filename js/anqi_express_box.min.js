...
function getExpressBoxSvgHtml(t, n, e, $) {
    ...
    const s = t * .5;
    const a = s + e * 2 + $ * 1;
    const l = mmToPxScale * t;
    const m = mmToPxScale * n;
    const h = mmToPxScale * e;
    const r = mmToPxScale * $;
    const v = mmToPxScale * THICKESS;
    const K = e * .5;
    const N = e * .25;
    const q = n * .25;
    const G = n * .5;
    const d = mmToPxScale * K;
    const g = mmToPxScale * G;
    const S = mmToPxScale * N;
    const x = mmToPxScale * q;
    const p = mmToPxScale * o(n, e) * .25;
    const w = h - S * 2 - v * 2;
    const u = m - x * 2 - v * 2;
    const I = h - p * 2 - v * 2;
    const L = m - r * 2 - v * 2;
    ...
    const A = b + e;
    const _ = A + $;
    T += `<path fill="none" stroke="#000000" d="M ${mmToPxScale*M},0 h ${l}
...
function getCuboidWithHalfExtend(t, n, e, $) {
    ...
    const c = t * 2 + e * 2 + $;
    const s = n + extend * 2;
    const a = mmToPxScale * t;
    const l = mmToPxScale * n;
    const m = mmToPxScale * e;
    const h = mmToPxScale * extend;
    const r = mmToPxScale * $;
    const v = 0;
    const d = v + extend;
    const g = d + n;
    ...
    const w = p + e;
    const u = w + t;
    const I = `<path fill="none" stroke="#000000"
d="M 0, ${h}
...
function getInnerHorizontalLine(t, n, e) {
    return `<line x1="${t}mm" x2="${n}mm" y1="${e}mm" y2="${e}mm" style="stroke:#888;stroke-width:0.1mm;stroke-dasharray:3 2;"></line>`
}

function getInlineVerticalLine(t, n, e) {
    return `<line x1="${t}mm" x2="${t}mm" y1="${n}mm" y2="${e}mm" style="stroke:#888;stroke-width:0.1mm;stroke-dasharray:3 2;"></line>`
}
...
function createAndAppendCuboids(n, e, $, o, i) {
    ...
    for (let t = 0; t < i; ++t) {
        const {
            ...
            width: a,
            height: l
        } = getCuboidWithSquareSectionSvgHtml(e, $, o);
        const {
            svgElement: m
        } = createSvgElement(s, a, l);
        n.appendChild(m);
        m.widthMm = a;
        m.heightMm = l;
        c.push(m)
...
function createAndAppendCuboid(t, n, e, $) {
    const {
        ...
        width: i,
        height: c
    } = getCuboidWithSquareSectionSvgHtml(n, e, $);
    const {
        svgElement: s
    } = createSvgElement(o, i, c);
    t.appendChild(s);
    s.widthMm = i;
    s.heightMm = c;
    return s
